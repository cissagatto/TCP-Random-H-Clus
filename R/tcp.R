...
cat("\n\n###################################################################")
cat("\n# ====> TCP-Random-H: OPTIONS CONFIGURATIONS                           #")
cat("\n#####################################################################\n\n")
...
cat("\n\n###################################################################")
cat("\n# ====> TCP-Random-H: READ DATASETS-2022                               #")
cat("\n#####################################################################\n\n")
setwd(FolderRoot)
...
cat("\n\n###################################################################")
cat("\n# ====> TCP-Random-H: GET THE ARGUMENTS COMMAND LINE                   #")
cat("\n#####################################################################\n\n")
args <- commandArgs(TRUE)


cat("\n\n###################################################################")
cat("\n# ====> TCP-Random-H: DATASET INFORMATION                              #")
cat("\n#####################################################################\n\n")
ds <- datasets[args[1],]

number_dataset <- as.numeric(args[1])
cat("\n\n###################################################################")
cat("\n# ====> TCP-Random-H: NUMBER DATASET: ", number_dataset, "             #")
cat("\n#####################################################################\n\n")


number_cores <- as.numeric(args[2])
cat("\n\n###################################################################")
cat("\n# ====> TCP-Random-H: GET THE NUMBER CORES: ", number_cores, "         #")
cat("\n#####################################################################\n\n")


number_folds <- as.numeric(args[3])
cat("\n\n###################################################################")
cat("\n# ====> TCP-Random-H: GET THE NUMBER FOLDS: ", number_folds, "         #")
cat("\n#####################################################################\n\n")


similarity <- toString(args[4])
cat("\n\n###################################################################")
cat("\n# ====> TCP-Random-H: GET THE STRING SIMILARITY: ", similarity, "      #")
cat("\n#####################################################################\n\n")


folderResults <- toString(args[5])
cat("\n\n###################################################################")
cat("\n# ====> TCP-Random-H: GET THE STRING FOLDER RESULTS: ", folderResults, " #")
cat("\n#####################################################################\n\n")


dataset_name <- toString(ds$Name)
cat("\n\n###################################################################")
cat("\n# ====> TCP-Random-H: GET THE DATASET NAME: ", dataset_name, "         #")
cat("\n#####################################################################\n\n")
...
cat("\n\n###################################################################")
cat("\n# ====> TCP-Random-H: CREATING FOLDER RESULTS TEMP                     #")
cat("\n#####################################################################\n\n")
...
cat("\n\n###################################################################")
cat("\n# ====> TCP-Random-H: CREATING DIRECTORIES                             #")
cat("\n#####################################################################\n\n")
diretorios = directories(dataset_name, folderResults)


cat("\n\n###################################################################")
cat("\n# ====> TCP-Random-H: ORGANIZANDO AS COISAS                            #")
cat("\n#####################################################################\n\n")


cat("\nCOPIANDO PARTIÇÕES")
str20 = paste("cp ~/TCP-Random-H/Partitions/", similarity ,"/", ds$Name,
...
cat("\nCOPIANDO DATASETS")
str26 = paste("cp ~/TCP-Random-H/Datasets/", ds$Name, ".tar.gz ",
